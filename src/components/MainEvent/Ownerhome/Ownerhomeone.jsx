    ...
    <div className='px-20 p-10 h-[100vh] md:h-[190vh]'>
      ...
      <div className='flex justify-between items-center'>
        ...
        <div className='flex justify-center items-center'>
          <p className=' text-sm md:text-xl'>You have selected a Frame <span className='font-bold'>A </span>and Size <span className='font-bold'>{sizeM}.</span>Confirm by making a payment of <span className='font-bold'>{A}.</span></p>
        </div>
