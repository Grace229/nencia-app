  ...
  return (
    ...
    <div className='flex justify-between items-center'>
      ...
      <div className='flex justify-center items-center'>
        <p className=' text-sm md:text-xl'>You have selected a Frame <span className='font-bold'>C </span>and Size <span className='font-bold'>{sizeM}.</span>Confirm by making a payment of <span className='font-bold'>{C}.</span></p>
      </div>
